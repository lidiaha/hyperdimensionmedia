...
<?php
   ...
   if (!$result) {
      echo "query error";
		...
		echo "<div class='dedicated'> Servizi SL per questo prodotto</div>";
      while($row = $result->fetch_assoc()) {
         ...
         echo "<div class=' info'><a class='more' href='/pages/service-presentation.html?service_id=$service_id'> Scopri </a></div>\n";
         echo "</div></div>\n";
