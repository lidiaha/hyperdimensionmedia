...
function processDevice(obj) {
   ...
   if (isApp()) {
      ...
      "<div class='devicepic' style=\"background: url('" + localizeData(obj.image) + "') no-repeat; background-size: contain; background-position: bottom center;\"></div>" +
      ...
      "<div class='devicepic' style=\"background: url('" + obj.image + "') no-repeat; background-size: contain; background-position: bottom center;\"></div>" +
      div_rate + div_price + div_promo +
      "</div>");
   }
}
