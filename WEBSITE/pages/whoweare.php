         ...
         <div id="contentwrapper" class="parallax-window" data-parallax="scroll" data-image-src="/pictures/bg-scroll-sea-2.jpg">
            <div id="maincontent">
               ...
               <div class='testimonial'>
                  <div class='quote one'> <div class='text'><b>Tim Berners-Lee</b><br>"Quando si osserva il web è come se si osservasse l'intera umanità."
                  </div></div>
						<div class='quote two'> <div class='text'><b>Fabio Fazio</b><br>"Si può essere dovunque con un click,andare dappertutto."
                  </div></div>
               </div>
               <div class='progetti'>
                  <div class='project'>
